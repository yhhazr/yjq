...
workTable = $('#workTable').dataTable({
	...
	$('.dataTables_length').parent().append("<div style='float:left;'><button class='btn btn-primary' id='newWork'><i class='icon-user icon-white'></i>新建工作</button></div>");
	function rowCallback(nRow, aData, iDisplayIndex){
		$('td:eq(3)', nRow).html("<button name='view' value="+aData.id+" class='btn btn-primary'><i class='icon-tasks icon-white'></i>工作详情</i></button>");
